# project-chaos_v3.7 UI audit_4b
...
| General/neutral (Orientation, Nav Protocols) | I WANT TO CHANGE THIS TO GRAY |                          |
...
| Accordion × 1 | "How to Navigate" protocol                              | Info Blue-- CHANGE TO GRAY |
| Tabs × 1      | Coordinate explanation: `Notation · Reading · Examples` | Info Blue CHANGE TO GRAY   |
...
| Component      | What                              | Accent                   |
| -------------- | --------------------------------- | ------------------------ |
| Accordion × ~5 | One per analysis method           | Info Blue CHANGE TO GRAY |
| FlipCard × ~5  | Worked examples inside accordions | Info Blue CHANGE TO GRAY |
...
| Component       | What                        | Accent                   |
| --------------- | --------------------------- | ------------------------ |
| Accordion × ~12 | Parts I-VI + appendices A-D | Info Blue CHANGE TO GRAY |
